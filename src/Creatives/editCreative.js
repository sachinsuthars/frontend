...
class EditCreative extends Component {
  ...
  componentWillMount(){
    ...
    this.props.changeInitial('Edit Creative');
        ...
        <div>
            ...
            <CardWithHeaderNoIcon title="Step 01" color="red">
              <div className="col-md-6">
                  <h4 className="card-title">Set a creative name</h4>
                    <div className="form-group label-floating">
                      <input onChange={this.setProjectName.bind(this)} type="text" className="form-control" id="creativeName"/>
                    </div>
                  <br/>
              </div>
            ...
            <ImageUpload creativeName={this.state.creativeName} clientChosen={this.state.layout} />
...
export default connect(mapStateToProps, mapDispatchToProps)(EditCreative);
